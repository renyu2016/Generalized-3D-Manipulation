...
def main(args):
	...
	os.makedirs(os.path.join(save_dir, "kpts"), exist_ok=True)

	cam_pos = args.cam_pos
	e = MetaWorldEnv(env_name, device="cuda:0", use_point_crop=True, cam_pos=cam_pos)
	...
	while episode_idx < num_episodes:
		...
		while not done:
			...
			total_count_sub += 1
			print("total_count", total_count_sub)
			...
			if ep_success and ep_success_times > 20:
				break
...
if __name__ == "__main__":
	...
	parser.add_argument('--cam_pos', type=list, default=[1.0, 0.195, 0.8])
