...
class SawyerSoccerEnvV2(SawyerXYZEnv):
    ...
    def evaluate_state(self, obs, action):
        ...
        # if success:
        #     self.record_dic[str(self.item_id)]["success"] = 1
            # with open(self.record_pos_file, 'w') as f:
            #     json.dump(self.record_dic, f)
    ...
    def reset_model(self):
        ...
        # self.item_id +=1
        # r_poses = {"obj": list(self.obj_init_pos), "success": 0}
        # self.record_dic[str(self.item_id)] = r_poses
